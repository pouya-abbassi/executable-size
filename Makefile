help:
	...
	@echo '                                                                                          '
	@echo '   make clang             Compile C file,        with static linking,              on LLVM'
	@echo '   make clang-dynamic     Compile C file,        with dynamic linking,             on LLVM'
	@echo '                                                                                          '
	...
	@echo '   make clang++               Compile C++ file,  with static linking,              on LLVM'
	@echo '   make clang++-dynamic       Compile C++ file,  with dynamic linking,             on LLVM'
	@echo '   make clang++-stdio         Compile C++ file,  with static linking, use cstdio,  on LLVM'
	@echo '   make clang++-stdio-dynamic Compile C++ file,  with dynamic linking, use cstdio, on LLVM'
	@echo '                                                                                          '
